...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART3_MspInit 0 */
    ...
    PB11     ------> USART3_RX 
    */
    GPIO_InitStruct.Pin = GSM_UART_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(GSM_UART_TX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = GSM_UART_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GSM_UART_RX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX 
    */
    HAL_GPIO_DeInit(GPIOB, GSM_UART_TX_Pin|GSM_UART_RX_Pin);
